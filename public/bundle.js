	...
	var NavBar = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                IndexLink,
	                { to: '/', className: 'btn btn-primary', activeClassName: 'btn-danger' },
	                ' Get Weather '
	            ),
	            _react2.default.createElement(
	                Link,
	                { to: '/about', className: 'btn btn-primary', activeStyle: { fontSize: '2em' } },
	                'About'
	            ),
	            _react2.default.createElement(
	                Link,
	                { to: '/examples', className: 'btn btn-primary', activeClassName: 'btn-danger' },
	                'Examples'
	            )
	        );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	    ...
	    handleSearch: function handleSearch(location) {
	        ...
	        getTemp(location).then(function (_ref) {
	            var data = _ref.data;
	    ...
	    render: function render() {
	        var renderMessage = function renderMessage() {
	            if (isLoading) return React.createElement(
	                ...
	                null,
	                'Fetching weather...'
	            );else return React.createElement(WeatherMessage, { temp: temp, location: location });
	        };
	        var _state = this.state,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = '0628ad6e3a8b2d973dce3d6bf4f03a11';

	var getTemp = function getTemp(location) {
	    var encodedLocation = encodeURIComponent(location);
	    var requestUrl = 'http://api.openweathermap.org/data/2.5/weather?q=' + encodedLocation + '&appid=' + OPEN_WEATHER_MAP_URL;
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias dolore minus natus nobis officia praesentium quia. Accusantium alias amet aut ducimus illo impedit ipsam minima repellendus, reprehenderit sapiente unde veritatis."
	                    ),
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
	                        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aliquam animi at autem, debitis dignissimos distinctio dolor excepturi fuga ipsam laboriosam laudantium maiores molestias odio placeat porro provident quae quo repellendus tenetur vitae voluptate voluptatem. Culpa cumque dolores est ex explicabo, hic inventore iste, quos rerum, sint sit tempore veniam."
	                    ),
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
	                    ...
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
	                        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid commodi doloremque earum esse, ipsa iure laboriosam maxime nesciunt pariatur perferendis, possimus quam quia quo rerum saepe tempore voluptate voluptates voluptatum!"
	                    ),
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
	                    ...
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
	                        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur dolor odio optio pariatur sunt temporibus!"
	                    ),
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
	                        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur, consequatur consequuntur dignissimos dolorem doloremque ducimus esse ex fuga illum iste labore, maiores, maxime molestias pariatur quae quaerat sapiente sit veritatis."
	                    ),
	                    _react2.default.createElement(
	                        "li",
	                        { className: "list-group-item" },
